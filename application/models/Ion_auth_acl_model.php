...
class Ion_auth_acl_model extends Ion_auth_model
{
     ...
     * @return bool
     */
    public function create_permission($perm_key =  FALSE, $perm_name = '', $parent_status = '', $desc = '')
    {
        ...
        $data = array('perm_key'=>$perm_key,'perm_name'=>$perm_name, 'parent_status' => $parent_status, 'description' => $desc);
     ...
     * @return array
     */
    public function permissions($format = 'ids', $key = 'id', $where = array())
    {
