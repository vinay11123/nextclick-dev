...
echo 'identity' ;exit;
	...
	public function login($identity, $password, $remember=FALSE, $fb=FALSE)
	{
		...
		$this->trigger_events('post_login_unsuccessful');
		$this->set_error('login_unsuccessful');
//var_dump($this->ion_auth->errors());die();
		return FALSE;
	}
	...
	public function get_users_groups($id=FALSE)
	{
		...
		return $this->db->select($this->tables['users_groups'].'.'.$this->join['groups'].' as id, '.$this->tables['groups'].'.name, '.$this->tables['groups'].'.description,'.$this->tables['groups'].'.modules' )
