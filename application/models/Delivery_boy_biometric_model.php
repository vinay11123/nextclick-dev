...
class Delivery_boy_biometric_model extends MY_Model
{
    public $rules;
    public function __construct()
    {
        parent::__construct();
        $this->table = 'delivery_boy_biometrics';
        $this->primary_key = 'id';
    ...
    public function customValidate($postData)
    {
        try {
            ...
            $validation = $validator->make($postData, [
                'aadhar'                       => 'nullable|min:12|max:12',
                'pan'                          => 'nullable|min:10|max:10',
                'vehicle_insurance'            => 'nullable|max:45',
                'driving_license'              => 'nullable|max:45',
                'vehicle_type_id'              => 'required',
                'shift_id'                     => 'required',
                'vehicle_number'               => 'nullable|max:20',
            ]);
            $validation->validate();
            if ($validation->fails()) {
