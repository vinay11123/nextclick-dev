        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <h3 class="text-center mb-4"><a class="btn-primary btn-sm" href="<?php echo base_url('register/r'); ?>">Back</a> Verify
                        Phone</h3>
                    ...
                    <form action="<?php echo base_url('register_otp/submit'); ?>" method="POST"
                        ...
                        <div class="form-group">
                            <label>OTP</label>
                            <input type="text" id="otp" name="otp" value="<?php echo set_value('otp'); ?>"
                                class="form-control numeric" placeholder="Enter OTP">
                        ...
                        <p class="text-danger text-center"><a href="#" id="sendOTP"
                                ...
                                class="text-danger">Resend
                                OTP</a></p>
                        <button type="submit" name="submit" id="submitLoaderButton"
                            class="btn btn-success btn-flat m-b-30 m-t-30">Verify
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#sendOTP').click(function (e) {
                ...
                if (phone) {
                    $.ajax({
                        url: "<?php echo base_url('executive/resend_otp'); ?>",
                        type: "POST",
                        data: {
                            phone_number: phone
                        },
