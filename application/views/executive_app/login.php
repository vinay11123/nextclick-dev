            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    ...
                    <?php if (isset($success_message)): ?>
                        <div class="text-center text-success"><?php echo $success_message; ?></div>
                    <?php endif;
                    $success_message = '';
                    ?>
                    ...
                    <form action="<?php echo base_url('executive/login/submit'); ?>" method="POST"
                        enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Mobile Number</label>
                            <input type="text" name="phone_number" id="phone_number" placeholder="Enter Phone Number"
                                value="<?php echo set_value('phone_number'); ?>" class="form-control numeric"
                                placeholder="">
                        ...
                        <div class="social-login-content">
                            <div class="social-button">
                                <a href="<?php echo base_url('login_otp_phone/r'); ?>" type="button"
