            ...
            <div class="pcoded-content">
                <div class="main-body">
                    <div class="page-wrapper">
                        <div class="row">
                            <div class="col-12">
                                <h4 class="ven text-center">All Vendors</h4>
                                <a class="btn btn-outline-dark col-2"
                                    href="<?php echo base_url('vendor_excel_import') ?>"><i class="feather icon-plus"
                                        aria-hidden="true"></i> Add Vendor</a>
                                <div class="card-body">
                                    <div class="card">
                                                    ...
                                                    <tbody>
                                                        <?php if (!empty($vendors)): ?>
                                                            ...
                                                            foreach ($vendors as $vendor): ?>
                                                                <tr>
                                                                    <td><?php echo $sno++; ?></td>
                                                                    <td><?php foreach ($executive as $ex):
                                                                        if ($vendor['executive_id'] == $ex['id']): ?>
                                                                                <?php echo $ex['id']; ?>
                                                                    ...
                                                                    <td><?php foreach ($constituency as $con):
                                                                        if ($vendor['constituency_id'] == $con['id']): ?>
                                                                                <?php echo $con['name']; ?>
                                                                            <?php endif; endforeach; ?>
                                                                    </td>
                                                                    ...
                                                                    <td><!-- <a href="#" class=" mr-2  " type="category" > <i class="fas fa-pencil-alt"></i>
                                                                        ...
                                                                        <a href="<?php echo base_url(); ?>vendor_profile/edit?id=<?php echo $vendor['id']; ?>"
                                                                            class="mr-2  "> <i class="feather icon-edit"></i>
                                                                        </a>
                                                                        <a href="<?= base_url('vendors/vendor?vendor_id=') . $vendor['id']; ?>"
                                                                            target="_blank" class=" mr-2  " type="category"> <i
                                                                                class="feather icon-eye"></i>
                                                                        </a>
                                                                        <a href="<?= base_url('vendor_payments/r?vendor_id=') . $vendor['id'] . "&id=" . $vendor['vendor_user_id']; ?>"
                                                                            target="_blank" class=" mr-2  " type="category"> <i
                                                                                class="feather icon-book"></i>
                                                                        </a>
                                                                    </td>
                    ...
                    <?php elseif ($type == 'approved'): ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a class="btn btn-outline-dark btn-lg col-2"
                                    href="<?php echo base_url('vendor_excel_import') ?>" style="float:right;"><i
                    ...
                    <?php elseif ($type == 'pending'): ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a class="btn btn-outline-dark btn-lg col-2"
                                    href="<?php echo base_url('vendor_excel_import') ?>"><i class="fa fa-plus"
                                        aria-hidden="true"></i> Add Vendor</a>
                                <div class="card-body">
                                    <div class="card">
                                        <div class="card-header">
