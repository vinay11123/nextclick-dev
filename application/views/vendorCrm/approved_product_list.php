                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo base_url('vendor_crm/myInventory/approved_list'); ?>">Approved List</a></li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="col-xl-12 col-md-12">
                                    ...
                                    <div class="card">
                                        <div class="card-block">
                                            <form method="post" id="form_search" action="<?php echo base_url('vendor_crm/myInventory/approved_list') ?>">
                                                <div class="row">
                                                    <div class="col-md-3">
                                    ...
                                    <div class="card">
                                        <div class="card-header text-dark bg-dark">
                                            <h5><i class="feather icon-home"></i> Approved (<?php echo count($approved_lists) ?>)</h5>
                                        </div>
                                        ...
                                        <form method="post" id="product_add" action="<?php echo base_url('vendor_crm/catalogue/catalogue_add') ?>">
                                            <div class="card-block border-bottom-info" style="margin-top: 30px;">
                                                ...
                                                <div class="row">
                                                    <?php foreach ($approved_lists as $key => $approved_list) { ?>
                                                        <div class="col-xl-4 col-md-12">
                                                            <div class="card coin-price-card table-card">
                                                                <div class="coin-title bg-c-blue">
                                                                    <div class="row">
                                                                        <div class="col-md-10">
                                                                            <h6 class="text-white m-b-0"><?php echo $approved_list['name']; ?></h6>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="card-block p-b-0">
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <img src="<?php echo base_url() ?>uploads/food_item_image/food_item_<?php echo $approved_list['image_id'] ?>.<?php echo $approved_list['image_ext']; ?>" width="100" height="auto" alt="" />
                                                                        </div>

                                                                        <div class="col-md-8">
                                                                            <p class="mb-0">Category: <?php echo $approved_list['sub_cat_name'] ?></p>
                                                                            <?php
                                                                            $sql = "SELECT * FROM vendor_product_variants where `item_id`=" . $approved_list['id'] . " and `vendor_user_id`=" . $this->ion_auth->get_user_id();
                                                                            $query = $this->db->query($sql);
                                                                            $items = $query->result_array();
                                                                            if (count($items) == 0) {
                                                                            ?>
                                                                                <a href="<?php echo base_url('vendor_crm/myInventory/approved_add') ?>?item_id=<?php echo $approved_list['id']; ?>" class="btn btn-success btn-sm mb-2"> Add Product </a>
                                                                            <?php } ?>
                                                                        </div>
