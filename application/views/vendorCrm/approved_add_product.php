            ...
            <div class="pcoded-inner-content">
                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        ...
                        <div class="page-body">
                            <div class="row">
                                <form method="post" id="product_update" action="<?php echo base_url('vendor_crm/myInventory/approved_update') ?>">
                                            ...
                                            <div class="card">
                                                <?php if ($key == 0) { ?>
                                                    <div class="card-header bg-dark">
                                                        ...
                                                        <span class="fa-pull-right"><a class="text-white" href="<?php echo base_url('vendor_crm/myInventory/approved_list'); ?>">Back</a></span>
                                                    </div>
                                                <?php } ?>
