<section class="showcase">
    ...
    <form action="<?php echo base_url('food/product/product_bulk_upload')?>" class="excel-upl" id="excel-upl" enctype="multipart/form-data" method="post" accept-charset="utf-8">
      <div class="row padall">
		...
		<div class="col-6 mt-3">
        	<label for="products_sheet">Upload products sheet</label>
