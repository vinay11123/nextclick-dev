  ...
  <div class="col-12">
        <div class="card-header">
          <h4 class="ven subcategory">Order List</h4>
             <form class="" novalidate="" action="<?php echo base_url('ongoing_orders/r/0');?>" method="post" enctype="multipart/form-data">
              <div class="row">
...
<?php } ?>
          ...
          <button type="submit" name="submit" id="upload" value="Apply" class="btn btn-primary mt-27 "><i class="fa fa-search newserch" aria-hidden="true"></i>&nbsp;Search</button>
            ...
            <form class="needs-validation h-100 justify-content-center align-items-center ptar" novalidate="" action="<?php echo base_url('ongoing_orders/r/0');?>" method="post">
