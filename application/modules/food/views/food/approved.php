...
<div class="row h-100 justify-content-center align-items-center">
	<div class="col-12">
    		<div class="card-header">
    			<h4 class="ven subcategory">Approved Product List</h4>
        		 <form class="" novalidate="" action="<?php echo base_url('food/food/approved/r/0');?>" method="post" >
        		 	<div class="row">
        		...
        		<form class="needs-validation h-100 justify-content-center align-items-center ptar" novalidate="" action="<?php echo base_url('food/approved/r/0');?>" method="post">
...
<div class="row">
	<div class="col-12">
		<div class="card-body">
			<div class="card">
				<div class="card-header">
					<h4 class="ven">Approved Product List</h4>
 ...
 if($this->ion_auth_acl->has_permission('inventory_view')):?>
								...
								print_r($vp['vendor_product_variants']);
