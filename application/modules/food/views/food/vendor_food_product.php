...
if($vendourproduct[0]['status'] == '3'){ echo '<span class="badge badge-success">Pending</span>'; } 
     ...
     <br><br><br>   <br>
                <?php  if($this->ion_auth_acl->has_permission('product_add_to_catalogue')):?>
           		<a href = "<?php echo base_url()?>vendor_req_product/0/changecat?id=<?php echo $vendourproduct[0]['id']; ?>" class="btn btn-secondary">Add To Catlogue</a>      
				<?php endif;?>
                </div>
...
<a href = "<?php echo base_url()?>employee/r/0" class="btn btn-warning">User Info</a><br><br>
 ...
 <?php  if($this->ion_auth_acl->has_permission('product_approval') && $vendourproduct[0]['status'] == 3):?>
   <a href = "<?php echo base_url()?>vendor_req_product/0/foodapprovestatus?id=<?php echo $vendourproduct[0]['id'];?>"   class="btn btn-info">Approve</a>
 <?php endif;?> 
                </div>
            </div>
          </div>
