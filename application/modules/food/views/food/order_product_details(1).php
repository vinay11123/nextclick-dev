                        ...
                        <div class="invoicecard-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <img src="../assets/img/logo.png" style="width: 200px !important ;"
                                                width="200">
                                            <address class="infoaddress">
                                                <span> <b>Address:</b></span>
                                                401, 4th Floor, New Mark House Hitech City, Patrika Nagar, Madhapur,
                                    ...
                                    <div class="mb-4 ">
                                        <div class="text-sm-right">
                                            <h4 class="invoice-color mb-2 mt-md-2">Invoice
                                                <span>#<?php echo $orderst[0]['id']; ?></span></h4>
                                            <ul class="list list-unstyled mb-0">
                                                <li> Invoice Date: <span class="font-weight-semibold">
                            ...
                            <div class="d-md-flex flex-md-wrap">
                                <div class="mb-4 mb-md-2 text-left"> <span class="text-muted">Invoice To:</span>
                                    <ul class="list list-unstyled mb-0">
                                        ...
                                        <li><span class="font-weight-semibold">
                                                <?php echo stripslashes(nl2br($orderst[0]['address'])); ?></span></li>
                                        <li> Mobile: <?php echo $orderst[0]['phone']; ?></li>

                                        <li> City: <?php echo $row1['City']; ?> - <?php echo $row1['Zipcode']; ?></li>

                                        <li><a class="mailtoa" href="mailto:tibco@samantha.com" data-abc="true">Email:
                                                <?php echo $orderst[0]['email']; ?></a></li>
                                    </ul>
                                </div>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">₹<?php echo $orderst[0]['delivery_fee']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
