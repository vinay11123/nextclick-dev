...
<div class="row">
	<div class="col-12">
		...
		<form class="needs-validation" novalidate="" action="<?php echo base_url('promotion_codes/c');?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						...
						<select class="form-control" name="promo_type" required=""  onchange="return promo_to_check(this.value)">
							<option value="1">Nextclick</option>
					...
					<div class="form-group col-md-4" id="vendors_list" style="display:none;">
						...
						<?php echo form_error('vendors_list', '<div style="color:red">', '</div>');?>
					</div>
					...
					<div class="form-group col-md-4">
						...
						<div class="form-group col-md-4">
							<label>Product</label>
						<select class="form-control" id="item_id" name="item_id" onChange="item_changed(this.value);" required="">
								<option value="" selected disabled>--select--</option>
						...
						<div class="form-group col-md-4">
							...
							<select class="form-control" id="sec_list" name="sec_list"  required="">
								<option value="" selected disabled>--select--</option>
								
							</select>
							<div class="invalid-feedback"><?=(($this->ion_auth->is_admin())? 'New Menu Name' : $this->category_model->get_cat_desc_account_name($vendor_category_id,'item_menu'));?>?</div>
							<?php echo form_error('sec_list','<div style="color:red>"','</div>');?>
						</div>
						...
						<table class="table table-striped table-hover" id="tableExport"
							...
							<?php if(!empty($promos)):?>
    							<?php  $sno = 1; foreach ($promos as $pro): ?>
									...
									<td><?php if($pro['promo_type']==1){echo 'Nextclick';}else{echo 'Not Available';} ;?><?=$pro['promo_type']?></td>
									...
									<td>
									 <a
										href="<?php echo base_url()?>promotion_codes/edit?id=<?php echo $pro['id'];?>"
										class=" mr-2  " type="ecom_category"> <i class="fas fa-pencil-alt"></i>
									</a>  
									<a href="#" class="mr-2  text-danger " onClick="delete_record(<?php echo $pro['id'] ?>, 'promotion_codes')"> <i
