...
*/
    ...
    <div class="row pb-4">
    <div class="col-md-12">
	<a style="border: 1px solid #373435;border-radius: 3px;padding: 4px;background-color: #373435;color: white;" href="<?php echo base_url('banner_images/r');?>">Promotions
...
Banner Images</a> 
    ...
    action="<?php echo base_url('promotion_banners/u');?>" method="post"
                           ...
                           <div class="multi-fields">
                              ...
                              <div class="multi-field">
                                 <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                       <label>Upload Image</label>
                                       <input class="form-control" type="file" accept="image/jpeg, image/png" name="image[]" id="image" class="form-control"> <br>
                                    </div>
                                 </div>
                                 <button type="button" class="remove-field" style="background-color:red;color:white;transform: translate(481px, -72px);">Remove</button>
