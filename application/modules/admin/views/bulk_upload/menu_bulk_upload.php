    ...
    <div class="row padall border-bottom">
      <div class="col-lg-12">
        <div class="float-right">
          <a href="<?php print site_url(); ?>dump/menu_bulk.xlsx" class="btn btn-info btn-sm"><i class="fa fa-file-excel"></i> Menu Sample .XLSX</a>
        </div>
      </div>
    </div>
    <?php //print_array(validation_errors());
    ?>
    <form action="<?php echo base_url('admin/bulk_upload/menu_upload') ?>" class="excel-upl" id="excel-upl" enctype="multipart/form-data" method="post" accept-charset="utf-8">
      <div class="row padall">
        ...
        <div class="col-12 mt-3">
          <label for="products_sheet">Upload Menu sheet</label>
          <input type="file" name="excel_file" id="excel_file" class="form-control col-6 mt-3" onchange="readURL(this);">
