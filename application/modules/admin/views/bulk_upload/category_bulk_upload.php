<section class="showcase">
    ...
    <div class="row padall border-bottom">  
      ...
      <div class="float-right">  
          <a href="<?php print site_url();?>dump/category_bulk.xlsx" class="btn btn-info btn-sm"><i class="fa fa-file-excel"></i> Categories Sample .XLSX</a>
        </div> 
      </div>
      </div>
	<?php //print_array(validation_errors());?>
    <form action="<?php echo base_url('admin/bulk_upload/category')?>" class="excel-upl" id="excel-upl" enctype="multipart/form-data" method="post" accept-charset="utf-8">
      <div class="row padall">
		...
		<div class="col-6 mt-3">
        	<label for="products_sheet">Upload Categories sheet</label>
