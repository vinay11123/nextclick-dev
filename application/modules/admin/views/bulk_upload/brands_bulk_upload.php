<section class="showcase">
  <div class="container">
    <div class="pb-2 mt-4 mb-2 border-bottom">
      <h2>Brands bulk upload</h2>
      <?php if (isset($this->session->flashdata('upload_status')['success'])) { ?>
        <div class="alert alert-success">
          <h5><?php echo $this->session->flashdata('upload_status')['success']; ?></h5>
        </div>
      <?php } elseif (isset($this->session->flashdata('upload_status')['error'])) { ?>
    ...
    <div class="row padall border-bottom">
      <div class="col-lg-12">
        <div class="float-right">
          <a href="<?php print site_url(); ?>dump/brands_bulk.xlsx" class="btn btn-info btn-sm"><i class="fa fa-file-excel"></i> Brands Sample .XLSX</a>
        </div>
      </div>
    </div>
    <?php //print_array(validation_errors());
    ?>
    <form action="<?php echo base_url('admin/bulk_upload/brands_upload') ?>" class="excel-upl" id="excel-upl" enctype="multipart/form-data" method="post" accept-charset="utf-8">
      <div class="row padall">
        ...
        <div class="col-6 mt-3">
          <label for="products_sheet">Upload Brands sheet</label>
