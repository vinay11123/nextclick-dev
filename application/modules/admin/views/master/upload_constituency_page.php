<section class="showcase">
    <div class="container">
      <div class="pb-2 mt-4 mb-2 border-bottom">
        <h2>Import ExcelSheet Constituency</h2>
    ...
    <div class="row padall border-bottom">  
      ...
      <div class="float-right">  
          <a href="<?php print site_url();?>dump/constituency_bulk.xlsx" class="btn btn-info btn-sm"><i class="fa fa-file-excel"></i> Sample .XLSX</a>
        </div> 
      </div>
      </div>
	<?php //print_array(validation_errors());?>
    <form action="<?php echo base_url('constituency/constituency_bulk_upload')?>" class="excel-upl" id="excel-upl" enctype="multipart/form-data" method="post" accept-charset="utf-8">
      <div class="row padall">
        <div class="form-group col-md-12">
			<label>Upload files here</label>
        </div>
		<div class="col-6 mt-3">
        	<label for="products_sheet">Upload Constituency sheet</label>
           	<input type="file" name="excel_file" id="excel_file" class="form-control" require="" onchange="readURL(this);">
