...
<div class="row">
  <div class="col-12">
    <h4 class="ven">Add Speciality</h4>
    <form class="needs-validation" novalidate="" action="<?php echo base_url('specialities/c');?>" method="post" enctype="multipart/form-data">
      <div class="card-header">
        <div class="form-row">
          <div class="form-group mb-0 col-md-4">
            <label>Name</label>
            <input type="text" class="form-control" name="name" required="" placeholder="Speciality Name" <?php echo set_value( 'name')?>>
            <div class="invalid-feedback">Give Title</div>
            <?php echo form_error( 'name', '<div style="color:red">', '</div>');?></div>
