		...
		<div class="row">
			<div class="col-md-12">
				<div class="main-card mb-3 card">
					<div class="card-header">Delivery Boy GST Reports</div>
					<div class="table-responsive">
						<table class="align-middle mb-0 table table-borderless table-striped table-hover">
							...
							<tbody>
								<?php $sno = 1;
								if (!empty($reports)) :
									foreach ($reports as $key => $txn) :
								?>
										<tr>
											<td><?php echo $sno++; ?></td>
											<td class="text-center"><?php echo $txn['first_name']; ?></td>
											<td class="text-center"><?php echo $txn['phone'] ?></td>
											<td>
												<a href="<?php echo base_url() ?>delivery_boy_wise_gst_report/<?php echo $txn['delivery_boy_user_id']; ?>" class=" mr-2">
													<?php echo $txn['total_gst_amount']; ?>
												</a>
											</td>
										</tr>
									<?php endforeach;
