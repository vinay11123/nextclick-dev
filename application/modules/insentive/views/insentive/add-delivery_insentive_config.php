<div class="row">
    <div class="col-12">
        <h4 class="ven">Add Delivery Insentive</h4>
        <form role="form" method="post" action="<?php echo site_url() ?>add-delivery_insentive_config">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control " id="district_id" name="district" required="">
                        <option value="">Select</option>
                    </select>
                </div>
                <div class="form-group col-md-4">
                    <label>Constituency</label>
                    <select class="form-control " id="constituancy_id" name="constituency" required="">
