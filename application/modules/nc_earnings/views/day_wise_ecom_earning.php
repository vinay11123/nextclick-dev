...
<div class="pcoded-main-container">
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card">
                                    <div class="card-header text-dark">
                                        <h5 class="text-dark" style="margin-top: 20px;">NC Day Wise Ecom Earnings</h5>
                                    </div>
                                            ...
                                            <div class="page-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-md-12">
                                                        ...
                                                        <form action="<?php echo base_url('day_wise_ecom_earnings'); ?>"
                                                            method="POST">
                                                            <div class="row">
                                                                <div class="col-md-4">
    ...
    <script>
        ...
        function openOrderDetailsModal(date) {
            console.log(date);
            $.ajax({
                url: '<?php echo base_url('nc_day_wise_ecom_earnings_modal'); ?>',
                method: 'POST',
                data: { date: date },
                dataType: 'json',
        ...
        // // Bind the function to the click event of the modal
        // $(document).on("click", ".order_details_modal", function (event) {
        //     event.preventDefault();
        //     var date = $(this).data('date');
        //     openOrderDetailsModal(date);
        // });
