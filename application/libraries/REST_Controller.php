...
abstract class REST_Controller extends MY_Controller {
     ...
     */
    const HTTP_OK = 200; //  success response

    /**
     * The server successfully created a new resource
     */
    const HTTP_CREATED = 201; // sucessfully inserted response
    const HTTP_ACCEPTED = 202; // successfully updated response
    const HTTP_NON_AUTHORITATIVE_INFORMATION = 203; // validation errors response

    /**
     * The server successfully processed the request, though no content is returned
     */
    const HTTP_NO_CONTENT = 204; // exist or not response
