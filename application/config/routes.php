...
$route['sub_category/(:any)'] = 'admin/master/sub_cat_delete/$1';
...
$route['exc_role/(:any)'] = 'admin/exc_role/$1';
...
$route['delivery/api/delivery/accept/(:num)'] = 'delivery/api/delivery/accept/$1';
...
$route['executive/reports'] = 'executive_app/ExecutiveLogin/reports';
$route['executive/vendor_checklist'] = 'executive_app/ExecutiveLogin/vendorchecklist';
$route['executive/view_details/(.+)'] = 'executive_app/ExecutiveLogin/viewdetails/$1';
$route['executive/myarchive'] = 'executive_app/ExecutiveLogin/myarchive';
...
$route['allusers'] = 'app/allusers';
$route['allvendors'] = 'app/allvendors';
$route['alldeliverypartner'] = 'app/alldeliverypartner';
$route['allexecutive'] = 'app/allexecutive';
$route['orderdetails/(:num)'] = 'app/orderdetails/$1';
$route['allorders'] = 'app/allorders';
